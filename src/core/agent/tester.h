#ifndef HIVE_CORE_TESTER_H
#define HIVE_CORE_TESTER_H
 ...
 * @param output_out Receives the tester output.
...
/**
 * OPTION 3: Return a pointer to the static tester agent descriptor.
