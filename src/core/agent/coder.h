#ifndef HIVE_CORE_CODER_H
#define HIVE_CORE_CODER_H
 ...
 * @param output_out Receives the coder output.
...
/**
 * OPTION 3: Return a pointer to the static coder agent descriptor.
